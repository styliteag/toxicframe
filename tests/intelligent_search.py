...
def main():
    ...
    parser.add_argument("--pattern-mutations", type=int, default=1,
                       help="Max pattern byte mutations (default: 1)")
    parser.add_argument("--suffix-mutations", type=int, default=2,
                       help="Max suffix byte mutations (default: 2)")
    ...
    try:
        if args.all or args.pattern_mutations:
        ...
        if args.all or args.suffix_mutations:
